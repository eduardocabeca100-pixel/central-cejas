...
function montarPastaEvento({ nomeEvento, empresa, dataEvento }) {
  ...
  return {
    ...
    pastaNome,
    nomeArquivo,
    caminhoLocalRelativo: path.join(ano, mes, pastaNome),
    caminhoStorage: `${ano}/${mes}/${pastaNome}/${nomeArquivo}`
  };
}
...
function registrarOrcamentoPdfServidor(app) {
  ...
  console.log("✅ Rota de PDF do orçamento no servidor carregada.");
}
